...
parser.add_argument('--region',     default=2,      type=int,    help='se region')
parser.add_argument('--searcher',   default=2,      type=int,    help='se searcher')
parser.add_argument('--sample',     default=8,      type=int,    help='se sample')
parser.add_argument('--player',     default=3,      type=int,    help='se player')
parser.add_argument('--cthre',      default=0.7,    type=float,  help='se crossover thre')
